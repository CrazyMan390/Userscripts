        ...
        var checkExistEpic = setInterval(function() {
            if ($('.css-8en90x').length) {
                ...
                pirateLinks.forEach((e) => {
                    ...
                    $(".css-18ikw62")[0].parentElement.parentElement.append(div)
                    $(".css-18ikw62")[0].parentElement.parentElement.append(rigEpic(e.url + appName + e.urlSpecial, e.title));
                })
...
function rigEpic(href, innerHTML) {
    let div = document.createElement("div");
    let button = document.createElement("a");
    let span = document.createElement("span");
    div.className = "css-15fg505"
    div.append(button)
    button.className = "css-18ikw62"
    button.href = href
    button.append(span)
